  ...
  return (
    <Card className="w-full border border-white bg-gradient-to-b from-zinc-800 to-gray-700">
      ...
      <CardBody>
        ...
        <Link href="/app/dao/new" shallow={true}>
...
export default function Page() {
  ...
  const handleRemoveOrbiDAOMembership = () => {
  ...
  return (
    <div className="flex flex-row w-full justify-center">
      <div className="flex flex-col justify-center align-middle">
        ...
        <Button className="mt-2" variant="bordered" onClick={handleRemoveOrbiDAOMembership}>
          Exit OrbiDAO Organization
        </Button>
      </div>
